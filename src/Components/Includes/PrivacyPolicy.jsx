    ...
    <>
      <div id="privacypolicy">
        <Container>
          <Row className="">
            <Col md={12}>
              <h2 className="text-primary py-3">Privacy Policy</h2>

              <div className="py-3 py-md-5">
                <p className="">
                  This Privacy policy is subject to the terms of the Site Policy
                  (User agreement) of this website.
                </p>
