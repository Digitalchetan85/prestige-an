  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://theprestigecitysarjapur.com/projects/avalon-park"
        />
        <meta
          name="description"
                      ...
                      <Container fluid className="ps-0 pe-0">
                        <Row>
                          <Col md={12}>
                            ...
                            <p>
                              Your home at Avalon Park is a well designed haven
                              that is abundant with natural light and
                              ventilation, thanks to imaginative and intelligent
                              planning.
                            </p>
                            <p>
                              Open the windows and allow Mother Nature herself
                              to keep your home cool and ventilated. The savings
                              on power aside, there’s nothing quite like
                              breathing in fresh air, is there? What’s more,
                              look out of any window and you will see a tapestry
