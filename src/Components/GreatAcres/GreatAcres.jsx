                    ...
                    <Row>
                      <Col md={12}>
                        ...
                        <p>
                          ...
                          development, and retail spaces. It is situated in East
                          Bengaluru with good connectivity to the rest of the
                          city. Prestige Great Acres is a plotted layout within
                          The Prestige City with a site area of around 81 acres.
                        </p>
                        <p>
                          This Prestige development boasts a variety of plot
                          sizes that cater to all requirements. The plotted
                          development has a grand entrance with a 20M wide road,
                          dedicated pedestrian zones, and lush gardens that
                          greet its residents. Three main entrances on all sides
                          of the property make accessing the site convenient for
                          all users.
                        </p>
                        <p>
                          Lavish green spaces provide ample space to create a
                          healthy natural environment. The elaborate pedestrian
                          pathways with a green buffer space make a stroll
                          through the community pleasant and safe. Almost all of
                          the plots are oriented towards the east and the west
                          with internal roads of a comfortable width of 12M and
                          9M depending on the varying requirements of the size
                          of the plots.
                        </p>
                      </Col>
                    </Row>
