  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://theprestigecitysarjapur.com/projects/aspen-greens"
        />
        <meta
          name="description"
                      ...
                      <Container fluid className="ps-0 pe-0">
                        <Row>
                          <Col md={12}>
                            ...
                            <p>
                              It comes to you with its own private garden area,
                              and covered space to park two cars comfortably.
                            </p>
                            <p>
                              Planned after the principles of Spanish
                              architecture, its layout enables you to entertain
                              with aplomb and be the perfect host while
                              safeguarding your privacy. For instance, its
                              entrance is positioned so that your guests can
                              access your living area and its accompanying lawn
                              directly, without having to traverse your family’s
                              personal spaces.
                            </p>
                            <p>
                              Seamlessly skirted by grassy paths, it blurs the
                              line between the outdoors and in, enveloping you
                              in nature’s warm embrace.
                            </p>
                            <p>
                              With four spacious bedrooms as well as a maid’s
                              room, large balcony decks opening from the
                              bedrooms, a central family area, and a commodious
                              kitchen, it promises you a life that is convenient
                              and comfortable even as it is elegant and classy.
                            </p>
                          </Col>
                        </Row>
                      </Container>
